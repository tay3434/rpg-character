...
export interface ReactiveController {
     ...
     */
    hostUpdated?(): void;
    hostShadowCreated?(shadowRoot: ShadowRoot): void;
    hostInternalsAttached?(internals: ElementInternals): void;
}
export interface ReactiveControllerHostClass {
    new (...args: any[]): ReactiveControllerHost;
}
export interface ReactiveControllerClass {
    new (...args: any[]): ReactiveController;
}
